...
//        final File file = new File("/storage/emulated/0"+lecture.getLocalUrl());
        ...
        if(contents.get(position).getType().equals("quiz") || contents.get(position).getType().equals("assignment")){
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(view.getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                        ...
                        String file_url = lecture.getWebUrl().replace("/storage/emulated/0/Android/data/online.rkmhikai/files/Videos", "https://rkmshillong.online/public/media/");
...
//                        Toast.makeText(view.getContext(),receiveUrl, Toast.LENGTH_LONG).show();
                        ...
                        new DownloadFileFromURL(view, lecture.getTitle()).execute(file_url);
                        holder.btnDownload.setImageResource(R.drawable.ic_baseline_check_circle_outline_24);
                        holder.btnDownload.setEnabled(false);
                    }
                } else {
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        DownloadFileFromURL(View view, String title) {
            this.view = view;
            this.title = title;
        }
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                String internalPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/online.rkmhikai/files/Videos/" + path1.replace("https://classroom.rkmshillong.org/public/media/" +
                        "", "");
