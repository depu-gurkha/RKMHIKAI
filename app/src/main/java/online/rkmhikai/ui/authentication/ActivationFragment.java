...
public class ActivationFragment extends Fragment {
    ...
    private void resendActivationEmail() {
        ...
        if (token.equals("") || email.equals("")) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.resendActivationEmail,
...
//                    params.put("email", "depukaf@gmail.com");
    ...
    private void updateEmail() {
        ...
        if (token.equals("") || email.equals("")) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.updateEmail,
                    new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
                            try {
...
//                    params.put("email", "depukaf@gmail.com");
    ...
    private void getActivationDetails() {
        ...
        request = new JsonObjectRequest(Request.Method.GET, URLs.getActivation + token, null, new Response.Listener<JSONObject>() {
            @Override
