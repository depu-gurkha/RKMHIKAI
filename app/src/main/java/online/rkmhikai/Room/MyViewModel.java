...
//            }
    ...
    public void getVolleyDetails() {
        ...
        String url = URLs.getCourseDetail+ SharedPrefManager.getInstance(getApplication().getApplicationContext()).getUCourseId();
...
//                                Toast.makeText(getApplication(), "Inside Volley", Toast.LENGTH_SHORT).show();
                                ...
                                for (int j = 0; j < chapterArray.length(); j++) {
                                    ...
                                    for (int k = 0; k < contentArray.length(); k++) {
                                        ...
                                        String localUrl = webUrl.replace("https://classroom.rkmshillong.org/public/media/","/Android/data/online.rkmhikai/files/Videos/");
